  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
        <div className="container-custom pt-32 pb-8 sm:pt-40 sm:pb-12">
          ...
          <div className="max-w-3xl">
            <div className="border-t border-border pt-8">
              ...
              <div className="space-y-10 text-foreground/90 leading-relaxed">
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">1. Introduction</h2>
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">2. Scope</h2>
                  <div className="space-y-4">
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">3. Personal Information We Collect</h2>
                  <div className="space-y-6">
                    <p>We collect personal information in the following categories:</p>

                    <div>
                      <h3 className="font-semibold text-foreground text-lg mb-2">A. Information You Provide Directly</h3>
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground text-lg mb-2">B. Information Collected Automatically</h3>
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground text-lg mb-2">C. Information from Third Parties</h3>
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">4. How We Use Personal Information</h2>
                  <div className="space-y-4">
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">5. Legal Basis for Processing (EEA/UK Visitors)</h2>
                  <div className="space-y-4">
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">6. Disclosure of Personal Information</h2>
                  <div className="space-y-6">
                    <p>We may disclose personal information to:</p>

                    <div>
                      <h3 className="font-semibold text-foreground text-lg mb-2">A. Service Providers</h3>
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground text-lg mb-2">B. Corporate Transactions</h3>
                      <p>In connection with mergers, acquisitions, financing transactions, or restructurings.</p>
                    </div>

                    <div>
                      <h3 className="font-semibold text-foreground text-lg mb-2">C. Legal Requirements</h3>
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">7. Data Retention</h2>
                  <div className="space-y-4">
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">8. Cookies and Tracking Technologies</h2>
                  <div className="space-y-4">
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">9. Data Security</h2>
                  <div className="space-y-4">
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">10. Your Rights</h2>
                  <div className="space-y-4">
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">11. California Privacy Rights</h2>
                  <div className="space-y-4">
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">12. International Transfers</h2>
                  <div className="space-y-4">
                ...
                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">13. Children's Privacy</h2>
                  <p>Our Site is not directed to children under 16. We do not knowingly collect personal information from children.</p>
                </section>

                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">14. Third-Party Links</h2>
                  <p>Our Site may contain links to third-party websites. We are not responsible for the privacy practices of those sites.</p>
                </section>

                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">15. Changes to This Policy</h2>
                  <p>We may update this Privacy Policy periodically. Updates will be posted with a revised "Last Updated" date.</p>
                </section>

                <section>
                  <h2 className="font-serif text-2xl sm:text-3xl text-foreground mb-4">16. Contact Information</h2>
                  <div className="space-y-4">
